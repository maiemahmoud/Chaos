...
clf_gini = DecisionTreeClassifier(criterion = "gini", random_state = 20,max_depth=3, min_samples_leaf=5)
clf_gini.fit(X_train, y_train)

clf_entropy = DecisionTreeClassifier(criterion = "entropy", random_state = 20,max_depth=3, min_samples_leaf=5)
...
lr_probs = clf_entropy.predict_proba(X_test)
